    ...
    <div class="container">
        ...
        <form action="insert_table.php" method="post">
            <div class="form-group">
                ...
                <select name="table_dropdown" class="custom-select mb-3">
                    <?php list_db() ?>
                </select>
            </div>
            ...
            <div id="columfamily">
                <div class="form-group">
                    ...
                    <select name="cf_dropdown" class="custom-select mb-3" id="cf_name" name="cf_name[]">
                        <?php list_db() ?>
                    </select>
                </div>
                <div class="form-group">
